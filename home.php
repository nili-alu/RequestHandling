      ...
      <header style="margin-bottom:10px;   text-align: center">
        <header>
          ...
          <nav style="margin-top:30px; ">
            <ul>
              <li class=" btn"><a href="studentsfeedbacks.php">View Feedback</a></li>
            </ul>
          </nav>
        ...
        <div class="dashboard-section" id="send-request">
          ...
          <form action="home.php" method="post">
            ...
            <label for="request_content">Request form</label>
            <input id="request_content" name="Requests_Content" required></input>
