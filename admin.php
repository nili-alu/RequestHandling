...
<body>
    <div style="display:flex;  grid-template-columns: 2;">
        <header style="margin:10px;  text-align: center">
            ...
            <div>
                <ul style="display:flex; list-style:none; margin-top:30%">
                    <li><a class="btn" href=" view.php">View Conversation</a> </li>
                    <li style="margin-left:50px"><a class="btn" href=" index.php">Back</a>
                    </li>
